     ...
     <el-container>
        <el-main>
               <el-breadcrumb separator="/">
                <el-breadcrumb-item :to="{ path: '/hot' }">分页管理</el-breadcrumb-item>
                <el-breadcrumb-item><a href="/hot">热门推荐</a></el-breadcrumb-item>
           </el-breadcrumb>
          <el-table :data="tableData">
              <el-table-column prop="id" label="ID" width="200"></el-table-column>
             <el-table-column prop="name" label="商品名称" width="350"></el-table-column>
                <el-table-column prop="img" label="商品图片" width="350">
...
<script>
  export default {
    ...
    methods: {
        ...
        getData(){
          this.$axios.get('http://localhost:3000/hot')
          .then((res)=>{
              //  console.log(res.data)
               var shuju=res.data
              //  console.log(this.tableData)
                this.tableData=shuju
                // console.log(this.tableData[0].bannerimg)
                  //控制台打印请求成功时返回的数据
               //bind(this)可以不用
          })
        }, 
